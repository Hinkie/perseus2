...
@section('conteudo')
	...
	<div class="container">
		<form method="POST" action="/funcionario/aluno"  enctype="multipart/form-data" >
			{{ csrf_field() }}
			<div class="form-row">
			...
			<div class="form-row">
				...
				<div class="form-group col-md-3 {{ $errors->has('desconto') ? ' has-error' : '' }}">
					...
					<input type="text"  class="form-control" id="desconto"  name="desconto"  value="{{ old('desconto') }}" required>
				</div>
			</div>	
			{{-- Contato --}}
			<div class="form-row">
			...
			<div class="form-row">
				<div class="form-group col-md-3 {{ $errors->has('curso_id') ? ' has-error' : '' }}">
					<label>Curso*</label>
					<select class="form-control" id="curso_id"   value="{{ old('curso_id') }}" name="curso_id" required>
