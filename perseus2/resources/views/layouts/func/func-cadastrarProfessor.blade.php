	...
	<div class="container">
		<form method="POST" action="/funcionario/professor">
			...
			<div class="form-row">
				...
				<div class="form-group col-md-3 {{ $errors->has('titulo_id') ? ' has-error' : '' }}">
					<label>Título*</label>
					<select class="form-control" id="titulo_id"  name="titulo_id"  value="{{ old('titulo_id') }}" required>
			...
			<div class="form-row">
				...
				<div class="form-group col-md-3 {{ $errors->has('tel_interno') ? ' has-error' : '' }}">
					...
					<input type="text"  class="form-control" id="tel_interno"  name="tel_interno"  value="{{ old('tel_interno') }}" onkeypress="mascara(this, '#####-####')">
				</div>
			</div>
			{{-- Usuario e funcao --}}
			<div class="form-row">
